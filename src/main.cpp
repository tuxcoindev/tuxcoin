...
uint256 hashGenesisBlock("0x000009f3092d671f6da53dbef5aee63d5a21be249784af338bb1ac45956b3a58"); //mainnet
...
static const int64 nTargetTimespan = 24 * 60 * 60; // TuxCoin: 1 day
static const int64 nTargetSpacing = 5 * 60; // TuxCoin: 5 minutues
...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const CBlockHeader *pblock) {
    /* current difficulty formula, TuxCoin - DarkGravity v2, written by Evan Duffield - evan@darkcoins.net - Changed by 7vpo*/
    const CBlockIndex *BlockLastSolved = pindexLast;
    const CBlockIndex *BlockReading = pindexLast;
    const CBlockHeader *BlockCreating = pblock;
    BlockCreating = BlockCreating;
...
{
    // TuxCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        hashGenesisBlock = uint256("0x000009f3092d671f6da53dbef5aee63d5a21be249784af338bb1ac45956b3a58");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block        
        const char* pszTimestamp = "CNN Money 29/Dec/2014 Shake Shack files for $100 million IPO";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        //If you want to copy tuxcoin, uncomment this part back in to create a new genesisblock
       // if (true && block.GetHash() != hashGenesisBlock)
              //  {
                ...
                assert(block.hashMerkleRoot == uint256("0x5c0628b4a767925a3cad610f88daca3a5147d92a471f06be47a44bbab42fffbf"));
